<div id="bpjgpt-sidebar">
  <div class="sidebar-content">
    ...
    <div class="sidebar-nav">
      <div class="nav-title text-unfold" title="我的工程" data-toggle="collapse" href="#engineering">
    ...
    <div class="sidebar-nav">
      <div class="nav-title text-fold" title="我的爆破批次" data-toggle="collapse" href="#batches">
        <div class="sidebar-icon">
          <span class="glyphicon glyphicon-play small-font smallsize-font"></span>
        </div>
        <div class="sidebar-text">
